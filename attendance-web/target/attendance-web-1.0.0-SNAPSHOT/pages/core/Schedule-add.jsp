	           ...
	           <div class="form-group">
                 ...
                 <div class="col-lg-9">
                    <div class="input-group date form_datetime" style="width:160px;float:left;" >
                        <input type="text" class="form-control" style="width:160px;" name="scheduleDate" id="scheduleDateID" dataType="Require">
...
<span class="required">*</span>    </div>
	           ...
	           <div class="form-group">
                    ...
                    <div class="col-lg-9">
	                       ...
	                       <input type="hidden" id="dutyTypeID_"  name="dutyType" />
    </div>
</div>
	           <div class="form-group">
                    ...
                    <div class="col-lg-9">
	                       ...
	                       <input type="hidden" id="scheduleTypeID_"  name="scheduleType" />
    </div>
</div>
</form>
