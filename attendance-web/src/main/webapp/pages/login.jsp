...
<body>
	...
	<video autoplay="autoplay" loop="loop" src="http://192.168.1.35/testll/video/LandingLoop.webm" style="width: 100%;position: fixed;top: 0;z-index: -1000;height: auto"></video>
	<div class="login_footer">Acetec Copyright © 2014-2015</div>
	<script>
    $(function(){
