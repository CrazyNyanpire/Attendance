...
<body>
	...
	<div class="g-head">
	    <nav class="navbar navbar-default">
	        <a style="margin-left: 20px;font-size: 20px;margin-top: 8px;" class="navbar-brand" href="#"><img style="display:none" src="<c:url value='/images/global.logo.png'/>"/>艾科人事考勤系统</a>
	...
	<div id="footer" class="g-foot">
	    <span>Copyright © 2014-2015 Acetec</span>
	</div>
