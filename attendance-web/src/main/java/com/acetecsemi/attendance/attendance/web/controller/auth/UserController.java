package com.acetecsemi.attendance.attendance.web.controller.auth;
...
public class UserController extends BaseController{
	...
	public Page pageJson(int page, int pagesize, Long roleId, 
	...
	public Page queryUsersForAssign(int page, int pagesize, Long roleId,
			String userNameForSearch, String userAccountForSearch) {
